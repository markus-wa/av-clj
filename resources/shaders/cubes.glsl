...
void main()
{
    ...
    float y = 0.25;
    freqs[0] = texture( iChannel0, vec2( 0.01, y ) ).x;
    freqs[1] = texture( iChannel0, vec2( 0.07, y ) ).x;
    freqs[2] = texture( iChannel0, vec2( 0.15, y ) ).x;
    freqs[3] = texture( iChannel0, vec2( 0.30, y ) ).x;
    //-----------
